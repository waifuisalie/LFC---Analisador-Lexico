...
VAR: .space 2  ; Variável VAR (16 bits)
_result_line_0: .space 2  ; Resultado da linha 0
_result_line_1: .space 2  ; Resultado da linha 1
...
linha_0:
    ...
    ; Armazena em variável VAR
    ld r16, Y+
    ld r17, Y+
    sts VAR, r16
    sts VAR+1, r17

    ; Armazena e exibe resultado da linha 0
    ld r16, Y+
    ld r17, Y+
    sts _result_line_0, r16
    sts _result_line_0+1, r17
...
linha_1:
    ...
    ; Armazena e exibe resultado da linha 1
    ld r16, Y+
    ld r17, Y+
    sts _result_line_1, r16
    sts _result_line_1+1, r17
